...
// InsertC provides a mock function with given fields: c, rec
func (_m *MockCats) InsertC(c context.Context, rec *model.Record) (uuid.UUID, error) {
	ret := _m.Called(c, rec)
...
// SelectAllC provides a mock function with given fields: c
func (_m *MockCats) SelectAllC(c context.Context) ([]*model.Record, error) {
	ret := _m.Called(c)
...
// SelectC provides a mock function with given fields: c, id
func (_m *MockCats) SelectC(c context.Context, id uuid.UUID) (*model.Record, error) {
	ret := _m.Called(c, id)
