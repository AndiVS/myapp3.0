...
// InsertCat provides a mock function with given fields: c, cat
func (_m *MockCats) InsertCat(c context.Context, cat *model.Cat) (uuid.UUID, error) {
	ret := _m.Called(c, cat)
...
// SelectAllCat provides a mock function with given fields: c
func (_m *MockCats) SelectAllCat(c context.Context) ([]*model.Cat, error) {
	ret := _m.Called(c)
...
// SelectCat provides a mock function with given fields: c, id
func (_m *MockCats) SelectCat(c context.Context, id uuid.UUID) (*model.Cat, error) {
	ret := _m.Called(c, id)
...
// UpdateCat provides a mock function with given fields: c, cat
