...
func (_m *MockUsers) AddU(c context.Context, rec *model.User) error {
	ret := _m.Called(c, rec)
...
// GetAllU provides a mock function with given fields: c
func (_m *MockUsers) GetAllU(c context.Context) ([]*model.User, error) {
	ret := _m.Called(c)
...
func (_m *MockUsers) SignIn(c echo.Context, user *model.User) error {
